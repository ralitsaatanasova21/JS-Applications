import { getAllTeaters } from "../api/data.js";
...
<section class="welcomePage">
    ...
    <div id="events">
        ...
        : html`${theaters.map(teaterTemplate)}`}
...
<div class="eventsInfo">
            ...
            <div class="info">
                <h4 class="title">${teater.title}</h4>
                <h6 class="date">${teater.date}</h6>
                <h6 class="author">${teater.author}</h6>
                <div class="info-buttons">
                    <a class="btn-details" href="/details/${teater._id}">Details</a>
                </div>
            </div>
        </div>
`
...
export async function homePage(ctx){
    const theaters=await getAllTeaters();
